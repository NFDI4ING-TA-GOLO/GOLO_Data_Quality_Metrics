...
.. note::
    ...
    Die Autoren; Hauke Dierend, Hendrik Görner und Rayen Hamlaoui möchten sich bei Bund, Ländern und bei der Gemeinsamen Wissenschaftskonferenz (GWK) 
...
.. toctree::
    ...
    regression_quality/1_REG_RMSE
    regression_quality/2_REG_MAE
    regression_quality/3_REG_R_Squared
